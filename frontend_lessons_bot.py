...
doctype_description = 'Тег <!DOCTYPE> описывает тип документа. Это одиночный тег. Пример: <!DOCTYPE html> указывает то, что документ написан на html. Также можно указать версию html, публичность, название организации и т.п. Однако обычно это не требуется.'
